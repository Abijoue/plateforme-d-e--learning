...
namespace PFA_Project.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(!await _roleManager.RoleExistsAsync(GestionRole.Etudiant)){
                        await _roleManager.CreateAsync(new IdentityRole(GestionRole.Etudiant));
                    }
                    ...
                    if(user.Status == 'E'){
                        ...
                        // inscription.IdEtudiant = user.Id;
                        await _userManager.AddToRoleAsync(user,GestionRole.Etudiant);
                        // _logger.LogInformation("List student Cours : "+inscription.IdEtudiant+" --- ");
                    }
